...
class DirectoryEntry {
  public:
    bool isDirectory;       // judge whether is a directory
...
class Directory {
  public:
    ...
    void List(int Dir_Sector);			// Print the names of all the files
					//  in the directory
    void Print();			// Verbose print of the contents
					//  of the directory -- all the file
					//  names and their contents.
    bool judge_directory(char *name); // judge whether it is directory
    void ExpandSize(int num); // expand the size
    bool Add_to_Directory(char *name, int newSector); // add to directory
