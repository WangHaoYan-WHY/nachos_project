...
#define SC_Makedir   16
#define SC_Console_Read   17
#define SC_Console_Write   18
#define SC_change_dir 19
#define SC_seek 20
 ...
 */ 
SpaceId Exec(char* exec_name, char *args[], int share_flag);
...
int Seek(int num, OpenFileId id);

int Console_Read(char *buffer, int size); // read content from console

int Console_Write(char *buffer, int size); // write content from console
